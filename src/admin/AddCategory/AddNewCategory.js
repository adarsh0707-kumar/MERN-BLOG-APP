...
const AddNewCategory = () => {
  ...
  const submitHandler = async (event) => {
    ...
    if (location.state == null) {
      ...
      axios
        .post(
          "http://www.localhost:3001/category",
          {
            name: categoryName,
      ...
      axios
        .put(
          `http://www.localhost:3001/category/${location.state.myData._id}`,
          {
            name: categoryName,
    ...
    <div className="addCategory">
      <form onSubmit={submitHandler} className="addCategory__form">
        <input
          ...
          className="addCategory__form__input"
          type="text"
        ...
        {imageUrl != null && (
          <img
            className="addCategory__form__img"
            src={imageUrl}
            alt={categoryName}
          />
        )}
        <button className="addCategory__form__btn" type="submit">
          {isLoding && (
            <CircularProgress
              size={22}
              color="inherit"
